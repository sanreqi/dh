        ...
        <div class="modal-body">
            <form id="user-form">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="AdminUserForm[username]" type="text" class="form-control" id="username"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="AdminUserForm[truename]" type="text" class="form-control" id="truename"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="AdminUserForm[mobile]" type="text" class="form-control" id="mobile"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="AdminUserForm[email]" type="text" class="form-control" id="email"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="AdminUserForm[password]" type="password" class="form-control" id="password">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="confirmPassword" class="col-sm-3 col-form-label">确认密码</label>
                    <div class="col-sm-9">
                        <input name="AdminUserForm[confirmPassword]" type="password" class="form-control" id="confirmPassword">
                    </div>
                </div>
                <input name="AdminUserForm[id]" type="hidden" value="<?php echo !empty($model) ? $model->id : ''; ?>">
            </form>
        </div>
